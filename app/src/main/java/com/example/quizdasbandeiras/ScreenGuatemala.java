...
public class ScreenGuatemala extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_guatemala);
    ...
    public void Confirm(View view) {
        ...
        if (idChecked == R.id.rbGuatemala) {
            pontos++;
        }

        textTitle.setText(String.valueOf(pontos));

        Intent it = new Intent(this, ScreenHungria.class);
