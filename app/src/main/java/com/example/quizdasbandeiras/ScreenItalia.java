...
public class ScreenItalia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_italia);
    ...
    public void Confirm(View view) {
        ...
        if (idChecked == R.id.rbItalia) {
            pontos++;
        }

        textTitle.setText(String.valueOf(pontos));

        Intent it = new Intent(this, ScreenIrlanda.class);
