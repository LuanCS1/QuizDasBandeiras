...
public class ScreenHungria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_hungria);
    ...
    public void Confirm(View view) {
        ...
        if (idChecked == R.id.rbHungria) {
            pontos++;
        }

        textTitle.setText(String.valueOf(pontos));

        Intent it = new Intent(this, ScreenItalia.class);
