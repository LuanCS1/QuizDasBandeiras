...
public class ScreenBulgaria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_screen_bulgaria);
        ...
        public void Confirm (View view){
            ...
            if (idChecked == R.id.rbBulgaria) {
                pontos++;
            }

            textTitle.setText(String.valueOf(pontos));

            Intent it = new Intent(this, ScreenJamaica.class);
