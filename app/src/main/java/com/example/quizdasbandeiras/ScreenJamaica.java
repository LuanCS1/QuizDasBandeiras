...
public class ScreenJamaica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_jamaica);
    ...
    public void Confirm(View view) {
        ...
        if (idChecked == R.id.rbCanada) {
            pontos++;
        }

        textTitle.setText(String.valueOf(pontos));

        Intent it = new Intent(this, ScreenJapan.class);
